...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/douglas-arg/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@douglas_uzu",
    icon: Instagram,
    url: "https://www.instagram.com/douglas_uzu/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Arggus-gr1ix",
    icon: Youtube,
    url: "https://www.youtube.com/@Arggus-gr1ix",
    color: "#FF0000",
